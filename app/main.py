...
app=FastAPI(title="National AI Orchestrator v8.0",version="3.0.0")
...
def home():
    return """<!doctype html><html lang='ko'><meta charset='utf-8'><meta name='viewport' content='width=device-width'><title>National AI Orchestrator v8.0</title>
...
<div class='w'><div class='c'><h1>National AI Orchestrator v8.0</h1><p>9 Agents · Official Knowledge Catalog · Hongcheon GIS Case · Law/KOSIS/Data · RAG · MCP</p><h3>지식베이스 자료 추가</h3><input id='file' type='file' accept='.pdf,.docx,.txt,.md'><button onclick='upload()'>자료 추가</button><span id='up'></span><hr><h3>질문</h3><textarea id='q'>철도 역세권 개발 시 법령·정책·데이터 관점의 검토사항을 정리해줘</textarea><br><button onclick='go()'>오케스트레이션 실행</button></div><div class='c'><h3>Agent Plan</h3><div id='plan'>대기 중</div><h3>최종 답변</h3><pre id='ans'>질문을 입력하고 실행하세요.</pre><details><summary>근거·검증 Trace 보기</summary><pre id='trace'></pre></details></div></div>
